...
app.post("/students", (req, res) => {
    ...
    // validation --> reject if any feild is missing
...
app.post("/login", (req, res) => {
    ...
    db.query(sql, [email], (error, results) => {
        if(error){
            console.error("logging query error:", error);
        ...
        // step 5: loggin successful --> return name so frontend can update nav bar
...
// Get /enrollments --> returns joind data(student name plus class name)
